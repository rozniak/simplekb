...
PACKAGE_POSTINST='./debian-postinst'
PACKAGE_PRERM='./debian-prerm'
...
TARGET_PACKAGE_POSTINST="${DEBIAN_ROOT}/postinst"
TARGET_PACKAGE_PRERM="${DEBIAN_ROOT}/prerm"
...
finalize_build()
{
    ...
    cp $PACKAGE_POSTINST $TARGET_PACKAGE_POSTINST
    cp $PACKAGE_PRERM    $TARGET_PACKAGE_PRERM

    chmod +x $TARGET_PACKAGE_POSTINST
    chmod +x $TARGET_PACKAGE_PRERM
}
